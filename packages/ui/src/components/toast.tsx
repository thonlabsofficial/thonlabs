...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ...
    className={cn(
      `
        fixed top-0 z-[100] flex max-h-screen w-full flex-col-reverse p-4 sm:top-0 sm:right-0 
...
const toastVariants = cva(
  `
    ...
    data-[swipe=move]:transition-none data-[state=open]:animate-in data-[swipe=end]:animate-out 
    data-[state=closed]:animate-out
    data-[state=closed]:fade-out data-[state=closed]:slide-out-to-top-full 
    sm:data-[state=closed]:slide-out-to-right-full sm:data-[state=closed]:slide-out-to-top-0
    data-[state=open]:slide-in-from-top-full 
    sm:data-[state=open]:slide-in-from-right-full sm:data-[state=open]:slide-in-from-top-0
  `,
  {
    variants: {
      variant: {
        default: 'bg-card/90 border-foreground/20 text-foreground',
